  ...
  return (
    <div className="relative inline-block">
      ...
      <motion.button
        ...
        className="relative px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg shadow-lg overflow-visible z-0 inline-flex items-center justify-center gap-2 inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary hover:bg-primary/90 h-10 relative overflow-visible bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white border-0 px-6 py-2 font-bold shadow-lg rounded-lg"
      ...
      >
        ...
        {/* REMOVED the button shine effect div */}
      </motion.button>
